...
--
-- Temporary table structure for view `lancamentos`
--

DROP TABLE IF EXISTS `lancamentos`;
/*!50001 DROP VIEW IF EXISTS `lancamentos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `lancamentos` AS SELECT
 1 AS `id_livro`,
  1 AS `titulo`,
  1 AS `autor`,
  1 AS `genero`,
...
--
-- Temporary table structure for view `sugestoes`
--

DROP TABLE IF EXISTS `sugestoes`;
/*!50001 DROP VIEW IF EXISTS `sugestoes`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `sugestoes` AS SELECT
 1 AS `id_livro`,
  1 AS `titulo`,
  1 AS `autor`,
  1 AS `genero`,
...
--
-- Final view structure for view `lancamentos`
--
...
/*!50013 DEFINER=`mugi`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `lancamentos` AS select `livro`.`id_livro` AS `id_livro`,`livro`.`titulo` AS `titulo`,`livro`.`autor` AS `autor`,`livro`.`genero` AS `genero`,`livro`.`idioma` AS `idioma`,`livro`.`situacao` AS `situacao`,`livro`.`id_editora` AS `id_editora`,`livro`.`imagem` AS `imagem` from `livro` where `livro`.`id_livro` >= 13 and `livro`.`id_livro` <= 15 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `sugestoes`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`mugi`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `sugestoes` AS select `livro`.`id_livro` AS `id_livro`,`livro`.`titulo` AS `titulo`,`livro`.`autor` AS `autor`,`livro`.`genero` AS `genero`,`livro`.`idioma` AS `idioma`,`livro`.`situacao` AS `situacao`,`livro`.`id_editora` AS `id_editora`,`livro`.`imagem` AS `imagem` from `livro` where `livro`.`id_livro` >= 8 and `livro`.`id_livro` <= 12 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-06-06 20:42:58
